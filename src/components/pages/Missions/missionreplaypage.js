                ...
                <div className='bg-starship_hero_4 bg-cover bg-center bg-no-repeat min-h-screen pb-10'>
                    ...
                    <div className='flex justify-center h-[68vh] xs:flex xs:flex-col'>
                        ...
                        <div className='bg-white p-5'>
                            ...
                            <div className='bg-white rounded-md h-[50vh] overflow-auto'>
